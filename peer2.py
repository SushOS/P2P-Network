    ...
    def get_peer_lists(self):
        ...
        for (s_host, s_port) in self.chosen_seeds:
            try:
                ...
                connected_peers.union(set(peer_list))
                # seed_socket.close()
...
#------------------------------------------------------------------------------------------
    def connect_to_peers(self):
        ...
        print(type(all_connected_peers), all_connected_peers)
        # all_connected_peers = all_connected_peers.split(",")
        print(type(all_connected_peers), all_connected_peers)
        all_connected_peers = list(all_connected_peers)
...
def main():
    ...
    peer = peerNode("127.0.0.1", 54382, config_data)
